let project = {
    ...
    "learned": "There are 2 things that stood out to me about making this project. The first was learning how to structure my sass files with partials. Prior to this project, I was placing all of my styles in one long stylesheet. I had come across the 7-1 Sass folder structure and used a smaller modified version for my project. This helped me organize my styles into components/pages and made it much easier to find where I wanted to make changes and update accordingly. \b The second I learned was how difficult it is to manage a project with many images. Looking back on the project, I didn’t properly format my images or reduce their sizes enough to make the website speed efficient. I’ve created a project todo to address these issues soon.",
