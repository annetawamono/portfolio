let project = {
    ...
    "text_class": "black",
    "hero_image": "media/images/megabooks.png",
    ...
    "learned": "Speaking non-technically, I learned that it’s important to reach out to your peers early on when making a project to clear up any doubts you have and to get yourself on the right path. It was very intimidating to build something with tech I’ve never used before and that slowed me down for the first few days of the project. \b On the technical side, I found that using VueJS is a great reactive framework for this kind of quick turnaround project. The vue-cli made setting up the project that much quicker and efficient. It’s my experience with Vue in this project that lead me to use it for my PWA app.",
